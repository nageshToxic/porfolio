  ...
  return (
    <>
     <div name="home" className='w-full h-screen bg-black text-white '>
      ...
      <p className='text-2xl sm:4xl mt-4'> A Full-stack-developer specialized in building responsive web applications </p>
      <div className='py-4'>
        ...
        <div className='max-w-[1000px] mx-auto flex flex-col justify-center h-full'>
          <img src={img} alt="" className='rounded-md sm:h-[300]' height={200} width={300} />
        </div>
